...
export const metadata = {
  title: "A1 Staffing Pro - LLC",
  description: "A1 Staffing Pro New Jersey offers premier staffing solutions, including temporary and full-time positions, recruitment services, and expert job placement. Connect with skilled professionals and explore rewarding career paths with our customized hiring solutions. Discover more today.",
  keywords: [
